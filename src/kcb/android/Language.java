...
public class Language extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener{
	...
	Button activate, info, update, helpButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      try{  lipukaApplication = (LipukaApplication)getApplication();
        ...
        if(lipukaApplication.isSavedProfile()){ 
 	 	...
 	 	*/
 	 	lipukaApplication.updatePublicKey(this);
 	 	lipukaApplication.updateProfileInBg();
}else{
	...
	adapter = new LanguageAdapter(this, items);
    ...
    protected void onStart() {
        super.onStart();
		lipukaApplication.setCurrentActivity(this);
		lipukaApplication.setActivityState(Language.class, true);
}

@Override
protected void onStop() {
    super.onStop();
    lipukaApplication.setActivityState(Language.class, false);
...
public void onClick(View arg0) {
	if (activate == arg0){
		...
		lipukaApplication.setCurrentDialogMsg("Please make sure you have data access before you continue. Do you want to continue?");
		showDialog(Main.DIALOG_CONFIRM_ID);
	}
	/*else if (register == arg0){
	
		Intent i = new Intent(EcobankHome.this, SelfActivation.class);
 		  startActivity(i);
	}*/
	else if (info == arg0 || helpButton == arg0){		
		help.setVisibility(View.VISIBLE);
        help.startAnimation(LipukaAnim.inFromRightAnimation());
	}
	else if (update == arg0){		
...
class AccountButtonListener implements View.OnClickListener{
	...
	return;
		...
		Intent i = new Intent(Language.this, EcobankMain.class);
		  startActivity(i);
