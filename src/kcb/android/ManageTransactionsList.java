...
import lipuka.android.view.adapter.MyAccountListAdapter;
...
public class ManageTransactionsList extends Activity implements OnClickListener, ResponseActivity,
AdapterView.OnItemClickListener{
	...
	String selectedSourceAccount, selectedProvider, deletedTransactionID;
	LipukaListItem[] sourceAccountsArray, providersArray;
...
try{
	        setContentView(R.layout.wu_manage_transactions_list);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("Manage Transactions");	   	
        ...
        try{      JSONArray txns = new JSONArray((String)extras.get(Constants.TXNS));

              for(int i = 0; i < txns.length(); i++){
              	items.add(txns.getJSONObject(i));  	
              }
              }catch(Exception ex){
		...
		ManageTransactionsAdapter adapter = new ManageTransactionsAdapter(this, items);
	    ...
	    listView.setOnItemClickListener(this);
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating transactions error", ex);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(ManageTransactionsList.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(ManageTransactionsList.class, false);
	    }
	    @Override
	        ...
	        return true;
	    		...
	    		public void onClick(View arg0) {
	    			...
	    			if(arg0.getId() == R.id.edit){
	    				JSONObject currentTransaction = (JSONObject)arg0.getTag();
	    		    	Intent intent = new Intent(this, EditTransaction.class);        
	    		        intent.putExtra(CURRENT_TRANSACTION, currentTransaction.toString());
	...
	lipukaApplication.clearPayloadObject();
			    	try{
			    		lipukaApplication.putPayload("send_money_txn_id", currentTransaction.getString("id"));
	    				deletedTransactionID = currentTransaction.getString("id");
		    			lipukaApplication.setServiceID("39");
	    			    }
	    			...
	    			}else if(arg0.getId() == R.id.more){
	    				JSONObject currentTransaction = (JSONObject)arg0.getTag();
	    				Intent intent = null;
	    			try{
	    				if(currentTransaction.getInt("status_code") == 0){
	    			    	intent = new Intent(this, ManageTransactionsDetails.class);    	
	    			    }else{
	    					intent = new Intent(this, TransactionDetails.class);
	    			    }
	   ...
	   public void showResponse(){
           ...
           lipukaApplication.setCurrentDialogMsg("Your cancellation/refund request has been accepted. You will be contacted within 24 hours by our customer service to complete your request. Thank you.");
	   ...
	   public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
	   	...
	   	showDialog(Main.DIALOG_PIN_ID);
	   			break;
	   	case 1:
	   		Intent i = new Intent(ManageTransactionsList.this, AccountStmt.class);
		    startActivity(i);		
	   		break;
	   		
	   	case 2:
	   		i = new Intent(ManageTransactionsList.this, Alerts.class);
		    startActivity(i);	   		
	   			break;
	   		case 3:
	   			i = new Intent(ManageTransactionsList.this, ChangePINcfc.class);
			    startActivity(i);	
	   		    break;
	   		case 4:
	   			i = new Intent(ManageTransactionsList.this, SetLanguage.class);
			    startActivity(i);		
	   			break;
	   		case 5:
	   			i = new Intent(ManageTransactionsList.this, EditProfileCfc.class);
			    startActivity(i);	  			
	   			break;
	   		case 6:
	   ...
	   public void deleteTransaction(){
		   JSONObject transactionToDelete = null;   
		   try{
		   		 for(JSONObject transaction: items){
	if(deletedTransactionID.equals(transaction.getString("id"))){
		transactionToDelete = transaction;
		   		...
		   		items.remove(transactionToDelete); 
		   		ListView listView = (ListView)findViewById(R.id.lipuka_list_view);
