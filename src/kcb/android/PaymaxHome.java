...
public class PaymaxHome extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener{
...
*/
		...
		//start temp
        setContentView(R.layout.paymax_home);
        ...
        homeItemList.add(new HomeItem(0, "", "Funds Transfer", 0, true));
        homeItemList.add(new HomeItem(0, "", "My Account", 0, true));
        homeItemList.add(new HomeItem(0, "", "ATM Locator", 0, true));
        homeItemList.add(new HomeItem(0, "", "Branch Locator", 0, true));
        gridview.setAdapter(new EcobankMainAdapter(this, homeItemList));
    ...
    protected void onStart() {
        super.onStart();
		lipukaApplication.setCurrentActivity(this);
		lipukaApplication.setActivityState(PaymaxHome.class, true);
...
protected void onStop() {
    super.onStop();
	lipukaApplication.setActivityState(PaymaxHome.class, false);
}
...
public void onClick(View arg0) {
	if (activate == arg0){
		...
		Intent i = new Intent(PaymaxHome.this, SelfActivation.class);
 		  startActivity(i);
...
case 0:
	...
	Intent i = new Intent(PaymaxHome.this, FundsTransfer.class);
    startActivity(i);
...
case 1:
	...
	i = new Intent(PaymaxHome.this, MyAccount.class);
    startActivity(i);
    lipukaApplication.clearNavigationStack();
...
case 2:
	...
	i = new Intent(PaymaxHome.this, FindAtm.class);
    startActivity(i);	
    lipukaApplication.clearNavigationStack();
		break;
	case 3:
		...
		i = new Intent(PaymaxHome.this, FindBranch.class);
	    startActivity(i);
	    lipukaApplication.clearNavigationStack();
	    break;
	case 4:
	...
	i = new Intent(PaymaxHome.this, PayBill.class);
	    startActivity(i);	
	    lipukaApplication.clearNavigationStack();
		break;
	case 6:
	i = new Intent(PaymaxHome.this, WithdrawCash.class);
	    startActivity(i);	
	    lipukaApplication.clearNavigationStack();
		break;
		case 7:
		lipukaApplication.setCurrentURL("http://zion.cellulant.com/AndroidWallet/ECOBANK/processorScripts/chequebk11.php");
		i = new Intent(PaymaxHome.this, ChequeBookRequest.class);
	    startActivity(i);	
	    lipukaApplication.clearNavigationStack();
		break;
	case 8:
		i = new Intent(PaymaxHome.this, FullStmt.class);
	    startActivity(i);
	    lipukaApplication.clearNavigationStack();
		break;
	case 9:
		i = new Intent(PaymaxHome.this, Forex.class);
	    startActivity(i);
	    lipukaApplication.clearNavigationStack();
		break;
	case 10:
...
lipukaApplication.clearNavigationStack();
		break;
	case 11:
i = new Intent(PaymaxHome.this, ChangePIN.class);
	     startActivity(i);
	     lipukaApplication.clearNavigationStack();
		break;
	case 12:
		i = new Intent(PaymaxHome.this, Accounts.class);
	     startActivity(i);
		break;
		default:
	...
	public void onClick(View arg0) {
		...
		if(!lipukaApplication.parsePinStatus(10)){ 
			if(!lipukaApplication.getOTP()){ 
	    		...
	    		Intent i = new Intent(PaymaxHome.this, OneTimePINActivity.class);
	    	     startActivity(i);
	return;
	}
	}
		...
		if(lipukaApplication.loadServiceXml(10+"_"+account.getType())){
			Intent i = new Intent(PaymaxHome.this, Main.class);
			  startActivity(i);
		}else{
			Toast toast = Toast.makeText(PaymaxHome.this, "Service not available", Toast.LENGTH_LONG);
			toast.show();
		}
