...
public class MgTransactionDetails extends Activity implements OnClickListener, ResponseActivity,
DateCaptureActivity{
...
try{
	        setContentView(R.layout.mg_transaction_details);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(MgTransactionDetails.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(MgTransactionDetails.class, false);
	    }
	    @Override
