...
public class AddCardAccount extends Activity implements OnClickListener, ResponseActivity
{
...
try{
	        setContentView(R.layout.add_card_account_step_two);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("Add Card Account");
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(AddCardAccount.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(AddCardAccount.class, false);
	    }
	    @Override
	    			...
	    			String cardAliasStr = cardAlias.getText().toString();	    		
	    				...
	    				errorBuffer.append("Card alias is missing\n");
	    			   			...
	    			   			if(valid){
	    				    			...
	    				    			lipukaApplication.setServiceID("61");
