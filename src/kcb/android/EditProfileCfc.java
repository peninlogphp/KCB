...
public class EditProfileCfc extends Activity implements OnClickListener, ResponseActivity{
...
try{
	        setContentView(R.layout.edit_profile_cfc);
...
title.setText("Edit Profile");
	        ...
	        emailAddress.setText(lipukaApplication.getProfileData("email"));
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating change pin error", ex);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(EditProfileCfc.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(EditProfileCfc.class, false);
	    }
	    @Override
	...
	/*    @Override
		...
		boolean valid = true;
	    			...
	    			String emailAddressStr = emailAddress.getText().toString();		    			
	    			    			...
	    			    			payloadBuffer.append(amountStr+"|");	    				
	    			    				...
	    			    				lipukaApplication.putPayload("old_password", currentPasswordStr);
	    			    				lipukaApplication.putPayload("new_password", newPasswordStr);
	    			    				lipukaApplication.putPayload("email", emailAddressStr);
    					    			lipukaApplication.setServiceID("46");
	   ...
	   public class ConfirmationDialog extends Dialog implements OnClickListener {
	    			...
	    			if (v == yesButton){
	    			dismiss();
					lipukaApplication.consumeService(lipukaApplication.getServiceID(), new EditProfileHandler(lipukaApplication, EditProfileCfc.this, emailAddress.getText().toString()));
