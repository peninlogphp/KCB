...
public class AccountStatementMiniNfull extends Activity implements OnClickListener, ResponseActivity,
...
try{
	        setContentView(R.layout.account_statement_mini_n_full);
		...
		items.add(new LipukaListItem("0", "Mini Statement", "EUR"));
		items.add(new LipukaListItem("0", "Full Statement", "GBP"));
	    ...
	    protected void onStart() {
	        super.onStart();
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(AccountStatementMiniNfull.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(AccountStatementMiniNfull.class, false);
	    }
	    @Override
	...
	/*    @Override
	   ...
	   public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
	   	...
	   	switch(position){
	   	case 0:
	   		lipukaApplication.setServiceID("53");
	   		lipukaApplication.setCurrentDialogTitle("PIN");
	   			   	      lipukaApplication.setCurrentDialogMsg("Please enter your mobile banking PIN");
	   			   	showDialog(Main.DIALOG_PIN_ID);
	   			break;
	   	case 1:
	   		Intent i = new Intent(AccountStatementMiniNfull.this, AccountStmt.class);
		    startActivity(i);		
	   		break;
	   		
	   	case 2:
	   		i = new Intent(AccountStatementMiniNfull.this, Alerts.class);
		    startActivity(i);	   		
	   			break;
	   		case 3:
	   			i = new Intent(AccountStatementMiniNfull.this, ChangePINcfc.class);
			    startActivity(i);	
	   		    break;
	   		case 4:
	   			i = new Intent(AccountStatementMiniNfull.this, SetLanguage.class);
			    startActivity(i);		
	   			break;
	   		case 5:
	   			i = new Intent(AccountStatementMiniNfull.this, EditProfileCfc.class);
			    startActivity(i);	  			
	   			break;
	   		case 6:
