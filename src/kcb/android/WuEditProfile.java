...
public class WuEditProfile extends Activity implements OnClickListener, ResponseActivity
{
...
try{
	        setContentView(R.layout.wu_edit_profile);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("Edit Gold Card Number");

	        goldCardNo = (EditText) findViewById(R.id.gold_card_no_field);
	        goldCardNo.setInputType(InputType.TYPE_CLASS_NUMBER);	
	        String goldCardNoStr = lipukaApplication.getProfileData("gold_card_no");
	        if(goldCardNoStr != null){
	        	goldCardNo.setText(goldCardNoStr);
	        }
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating edit gold card number error", ex);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(WuEditProfile.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(WuEditProfile.class, false);
	    }
	    @Override
	    ...
	    public boolean onHandleActionBarItemClick(ActionBarItem item, int position) {
	        ...
	        return true;
	    		...
	    		if (submit == arg0){
        			...
        			String goldCardNoStr = goldCardNo.getText().toString();
	    			
	    			if(goldCardNoStr == null || goldCardNoStr.length() == 0){
	    				valid = false;
	    				errorBuffer.append("Gold card number is missing\n");
	    			}
	    			...
	    			if(valid){
	    		        			...
	    		        			/*	payloadBuffer.append(enteredStartDate.get(Calendar.YEAR));
	    		        				...
	    		        				lipukaApplication.putPayload("gold_card_no", goldCardNoStr);
...
amountStr = "You have successfully edited your gold card number to "+goldCardNoStr+". Thank you.";
	    		        			}else{
	   ...
	   public String getGoldCardNo(){
		   return goldCardNo.getText().toString();
	   }
	    	    }