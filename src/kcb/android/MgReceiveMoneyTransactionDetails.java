...
public class MgReceiveMoneyTransactionDetails extends Activity implements OnClickListener, ResponseActivity,
DateCaptureActivity{
...
try{
	        setContentView(R.layout.mg_receive_money_transaction_details);
	        ...
	        TextView destinationAccount = (TextView)findViewById(R.id.destination_account_field);
	        ...
	        refNo.setText(transaction.getString("mtcn"));
	        ...
	        destinationAccount.setText(transaction.getString("destination_account"));
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating transaction details error", ex);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(MgReceiveMoneyTransactionDetails.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(MgReceiveMoneyTransactionDetails.class, false);
	    }
	    @Override
