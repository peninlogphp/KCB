...
public class CreateMobileAccountNormal extends Activity implements OnClickListener{
...
try{
	setContentView(R.layout.create_mobile_account_normal);	    
  ...
  currentSource.getString("name"), currentSource.getString("value"));
	...
	spinner.setAdapter(adapter);
	    ...
	    protected void onStart() {
	        super.onStart();
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(CreateMobileAccountNormal.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(CreateMobileAccountNormal.class, false);
	    }
	    @Override
	    			...
	    			String secretAnswerStr = secretAnswer.getText().toString();	
	    				...
	    				errorBuffer.append("Secret answer is missing\n");
	    			   			...
	    			   			if(valid){
	    				    			    				...
	    				    			    				//lipukaApplication.consumeService("56", new CreateAccountHandler(lipukaApplication, this));
	    				    			    			showResponse();		
	    				    			    			}else{
