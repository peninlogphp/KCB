...
public class MyAccount extends Activity implements OnClickListener, ResponseActivity,
...
try{
		...
		//items.add(new LipukaListItem("0", "Balance", "EUR"));
		//items.add(new LipukaListItem("0", "Activate Card", "GBP"));
		items.add(new LipukaListItem("0", "Change Mobile PIN", "TZS"));
		items.add(new LipukaListItem("0", "Edit Profile", "TZS"));
		items.add(new LipukaListItem("0", "Manage Card Accounts", "TZS"));   
		items.add(new LipukaListItem("0", "Manage Beneficiary Phone Numbers", "TZS"));   
		items.add(new LipukaListItem("0", "Language", "TZS"));   
		items.add(new LipukaListItem("0", "Manage Beneficiary Card Numbers", "TZS"));   

		MyAccountListAdapter adapter = new MyAccountListAdapter(this, items);
	    ...
	    listView.setOnItemClickListener(this);
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating my account error", ex);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(MyAccount.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(MyAccount.class, false);
	    }
	    @Override
	...
	/*    @Override
	   ...
	   public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
	   	...
	   	switch(position){
	   	/*case 0:
			lipukaApplication.setServiceID("44");
lipukaApplication.setCurrentDialogTitle("PIN");
	   	      lipukaApplication.setCurrentDialogMsg("Please enter your mobile banking PIN");
	   	showDialog(Main.DIALOG_PIN_ID);
	   			break;*/
	   	case 0:
	   		Intent i = new Intent(MyAccount.this, ChangePINcfc.class);
		    startActivity(i);		
	   		break;
	   		
	   	case 1:
	   		i = new Intent(MyAccount.this, EditProfileCfc.class);
		    startActivity(i);	   		
	   			break;
	   		case 2:
	   			i = new Intent(MyAccount.this, ManageCardAccounts.class);
			    startActivity(i);	
	   		    break;
	   		case 3:
	   			i = new Intent(MyAccount.this, ManageSavedCards.class);
			    startActivity(i);		
	   			break;
	   		case 4:
	   			i = new Intent(MyAccount.this, SetLanguage.class);
			    startActivity(i);	  			
	   			break;
	   		case 5:
	   			i = new Intent(MyAccount.this, ManageSavedCardNumbers.class);
			    startActivity(i);	   			
	   			break;
	   			case 6:
