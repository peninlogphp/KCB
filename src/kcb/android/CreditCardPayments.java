...
public class CreditCardPayments extends Activity implements OnClickListener, ResponseActivity{
...
try{
	        ...
	        title.setText("Credit Card Payments");
	  ...
	  try{      JSONArray sources = new JSONArray(lipukaApplication.loadSourceAcounts());
	    ...
	    protected void onStart() {
	        super.onStart();
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(CreditCardPayments.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(CreditCardPayments.class, false);
	    }
	    @Override
