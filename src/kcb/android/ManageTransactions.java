...
public class ManageTransactions extends Activity implements OnClickListener, ResponseActivity,
DateCaptureActivity{
	...
	String selectedAccount, selectedCountry, selectedCountryValue;
...
try{
	        setContentView(R.layout.wu_manage_transactions);
...
startDate = (EditText)findViewById(R.id.start_date_field);
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating manage transaction error", ex);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(ManageTransactions.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(ManageTransactions.class, false);
	    }
	    @Override
	    		    ...
	    		    Calendar enteredEndDate = null;	    	        			    		        
	    		        		...
	    		        		try{	
	    		        			...
	    		        			/*	payloadBuffer.append(enteredStartDate.get(Calendar.YEAR));
	    			    				...
	    			    				lipukaApplication.consumeService("35", new FetchTxnsHandler(lipukaApplication, this, TransactionHistory.SEND_MONEY));
