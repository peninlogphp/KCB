...
public class EditCardAccount extends Activity implements OnClickListener, ResponseActivity
{
...
try{
	        setContentView(R.layout.edit_card_account);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("Edit Card Account");

	        Bundle extras = getIntent().getExtras(); 

	        cardNo = (TextView) findViewById(R.id.card_no_field);
	        ...
	        try {
		        ...
		        selectedCardID = card.getString("account_id");
     cardNo.setText(card.getString("account_mask"));
	        cardAlias.setText(card.getString("account_alias"));
	        }
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(EditCardAccount.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(EditCardAccount.class, false);
	    }
	    @Override
	        ...
	        return true;
	    		...
	    		if (submit == arg0){
	    			...
	    			if(cardAliasStr == null || cardAliasStr.length() == 0){
	    				valid = false;
	    				errorBuffer.append("Card Alias is missing\n");
	    			} 
	    			if(valid){
