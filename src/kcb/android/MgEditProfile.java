...
public class MgEditProfile extends Activity implements OnClickListener, ResponseActivity
{
	   
	Button submit;
	EditText customerCardNo;
	RelativeLayout help;
	...
	String selectedAccount, selectedCountry;
	LipukaListItem[] accountsArray, destinationCountriesArray;
	    @Override
	    public void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        lipukaApplication = (LipukaApplication)getApplication();
try{
	        setContentView(R.layout.mg_edit_profile);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("Edit Customer Card Number");

	        customerCardNo = (EditText) findViewById(R.id.customer_card_no_field);
	        customerCardNo.setInputType(InputType.TYPE_CLASS_NUMBER);	
	        String customerCardNoStr = lipukaApplication.getProfileData("gold_card_no");
	        if(customerCardNoStr != null){
	        	customerCardNo.setText(customerCardNoStr);
	        }
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating edit customer card number error", ex);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(MgEditProfile.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(MgEditProfile.class, false);
	    }
	    @Override
	    ...
	    public boolean onHandleActionBarItemClick(ActionBarItem item, int position) {
	        ...
	        return true;
	    		...
	    		if (submit == arg0){
        			...
        			String customerCardNoStr = customerCardNo.getText().toString();
	    			
	    			if(customerCardNoStr == null || customerCardNoStr.length() == 0){
	    				valid = false;
	    				errorBuffer.append("Customer card number is missing\n");
	    			}
	    			...
	    			if(valid){
	    		        			...
	    		        			/*	payloadBuffer.append(enteredStartDate.get(Calendar.YEAR));
	    		        				...
	    		        				lipukaApplication.putPayload("gold_card_no", customerCardNoStr);
	    				    			lipukaApplication.setServiceID("40");
...
amountStr = "You have successfully edited your customer card number to "+customerCardNoStr+". Thank you.";
	    		        			}else{
	   ...
	   public String getCustomerCardNo(){
		   return customerCardNo.getText().toString();
	   }
	    	    }