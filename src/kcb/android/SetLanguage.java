...
public class SetLanguage extends Activity implements OnClickListener, ResponseActivity,
...
try{
		...
		SetLanguageAdapter adapter = new SetLanguageAdapter(this, items);
	    ...
	    listView.setOnItemClickListener(this);
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating set language error", ex);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(SetLanguage.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(SetLanguage.class, false);
	    }
	    @Override
...
showResponse();
	  /* 	switch(position){
	   	...
	   	showDialog(Main.DIALOG_PIN_ID);
	   			break;
	   	case 1:
	   		Intent i = new Intent(SetLanguage.this, AccountStmt.class);
		    startActivity(i);		
	   		break;
	   		
	   	case 2:
	   		i = new Intent(SetLanguage.this, Alerts.class);
		    startActivity(i);	   		
	   			break;
	   		case 3:
