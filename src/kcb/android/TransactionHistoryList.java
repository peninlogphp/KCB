...
public class TransactionHistoryList extends Activity implements OnClickListener, ResponseActivity,
...
try{
	        setContentView(R.layout.wu_transaction_history_list);
 ...
 Bundle extras = getIntent().getExtras(); 
	         ...
	         type = (Byte)extras.get(TransactionHistory.TRANSACTION_TYPE);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(TransactionHistoryList.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(TransactionHistoryList.class, false);
	    }
	    @Override
	...
	/*    @Override
	        ...
	        return true;
	    		...
	    		public void onClick(View arg0) {
	    		     ...
	    		     if(type == TransactionHistory.SEND_MONEY){
	    			    	...
	    			    	intent = new Intent(this, ReceiveMoneyTransactionDetails.class);    	
	    		     }  
	   ...
	   public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
	   	...
	   	showDialog(Main.DIALOG_PIN_ID);
	   			break;
	   	case 1:
	   		Intent i = new Intent(TransactionHistoryList.this, AccountStmt.class);
		    startActivity(i);		
	   		break;
	   		
	   	case 2:
	   		i = new Intent(TransactionHistoryList.this, Alerts.class);
		    startActivity(i);	   		
	   			break;
	   		case 3:
	   			i = new Intent(TransactionHistoryList.this, ChangePINcfc.class);
			    startActivity(i);	
	   		    break;
	   		case 4:
	   			i = new Intent(TransactionHistoryList.this, SetLanguage.class);
			    startActivity(i);		
	   			break;
	   		case 5:
	   			i = new Intent(TransactionHistoryList.this, EditProfileCfc.class);
			    startActivity(i);	  			
	   			break;
	   		case 6:
