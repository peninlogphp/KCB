...
public class MgEditBeneficiary extends Activity implements OnClickListener, ResponseActivity
{
...
try{
	        setContentView(R.layout.mg_edit_beneficiary);
     ...
     fname.setText(beneficiary.getString("first_name"));
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(MgEditBeneficiary.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(MgEditBeneficiary.class, false);
	    }
	    @Override
