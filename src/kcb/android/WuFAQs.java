...
public class WuFAQs extends Activity implements OnClickListener, ResponseActivity{
...
try{
	        setContentView(R.layout.wu_faqs);
	    ...
	    protected void onStart() {
	        super.onStart();
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(WuFAQs.class, true);
	    ...
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(WuFAQs.class, false);
	    }
	    @Override
