...
public class SalaryAdvance extends Activity implements OnClickListener, ResponseActivity{
	  ...
	  try{      JSONArray sources = new JSONArray(lipukaApplication.loadSourceAcounts());
	      ...
	      currentSource.getString("name"), currentSource.getString("value"));
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating salary advance error", ex);
	    ...
	    protected void onStart() {
	        super.onStart();
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(SalaryAdvance.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(SalaryAdvance.class, false);
	    }
	    @Override
	...
	/*    @Override
	    				...
	    				errorBuffer.append("Amount is missing\n");
	    			    			...
	    			    			payloadBuffer.append(amountStr+"|");	    				
	    			    				...
	    			    				lipukaApplication.setCurrentDialogTitle("Confirm");
	    			    			      lipukaApplication.setCurrentDialogMsg("You are about to request for a salary advance of Ksh. "+amountStr+
	    			    			    		  ". Press \"OK\" to request now or \"Cancel\" to edit request details");
	   ...
	   public void showResponse(){
			lipukaApplication.setCurrentDialogTitle("Response");
		      lipukaApplication.setCurrentDialogMsg("Dear Alice, you have successfully requested for a salary advance of Ksh. "+amountStr+". Thank you.");
