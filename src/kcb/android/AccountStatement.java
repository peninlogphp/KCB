...
public class AccountStatement extends Activity implements OnClickListener, DateCaptureActivity, ResponseActivity{
...
String selectedAccount;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        OnClickListener accountListener = new OnClickListener() {
            public void onClick(View v) {
                // Perform action on clicks
                RadioButton rb = (RadioButton) v;
                selectedAccount = rb.getText().toString();
            }
        };
        
        final RadioButton salary = (RadioButton) findViewById(R.id.salary);
        final RadioButton remittance = (RadioButton) findViewById(R.id.remittance);
       
        salary.setOnClickListener(accountListener);
        remittance.setOnClickListener(accountListener);
    ...
    protected void onStart() {
        super.onStart();
		lipukaApplication.setCurrentActivity(this);
		lipukaApplication.setActivityState(AccountStatement.class, true);
		}
   
    @Override
    protected void onStop() {
        super.onStop();
		lipukaApplication.setActivityState(AccountStatement.class, false);
    }
	@Override
...
Calendar enteredEndDate = null;
    			...
    			if(selectedAccount == null || selectedAccount.length() == 0){
    				valid = false;
    				errorBuffer.append("Select account\n");
    			}
    		...
    		try{	
    			...
    			if(valid){
    				...
    				lipukaApplication.putPayload("source_account_id", startDateStr);
