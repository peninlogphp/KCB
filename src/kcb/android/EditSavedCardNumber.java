...
public class EditSavedCardNumber extends Activity implements OnClickListener, ResponseActivity
{
...
try{
	        setContentView(R.layout.edit_card_number);
	        ...
	        try {
		        ...
		        selectedCardID = card.getString("saved_card_beneficiary_id");
     cardNo.setText(card.getString("card_no"));
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(EditSavedCardNumber.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(EditSavedCardNumber.class, false);
	    }
	    @Override
	    		...
	    		if (submit == arg0){
	    			...
	    			if(valid){
	    		        			...
	    		        			/*	payloadBuffer.append(enteredStartDate.get(Calendar.YEAR));
	    			    				...
	    			    				lipukaApplication.putPayload("saved_destination_beneficiary_id", selectedCardID);
	    			    				lipukaApplication.putPayload("card_no", cardNoStr);
	    			    				lipukaApplication.putPayload("alias", cardAliasStr);
	    			    				
	    				    			lipukaApplication.setServiceID(String.valueOf(Constants.EDIT_CARD_NUMBER));
