...
public class MgFAQs extends Activity implements OnClickListener, ResponseActivity{
...
try{
	        setContentView(R.layout.mg_faqs);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("FAQs");
	        
	        WebView faqsWebView = (WebView) findViewById(R.id.faqs);
	        WebSettings faqsWebSettings = faqsWebView.getSettings();
	        faqsWebSettings.setJavaScriptEnabled(true);
	        //faqsWebView.setBackgroundColor(0);
	        faqsWebView.loadUrl("file:///android_asset/mg_faqs.html");
	    ...
	    protected void onStart() {
	        super.onStart();
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(MgFAQs.class, true);
	    ...
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(MgFAQs.class, false);
	    }
	    @Override
	...
	/*    @Override
	   ...
	   public void showResponse(){
			lipukaApplication.setCurrentDialogTitle("Response");
		      lipukaApplication.setCurrentDialogMsg("");
