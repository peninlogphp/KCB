...
public class TransactionHistory extends Activity implements OnClickListener, ResponseActivity,
DateCaptureActivity{
...
try{
	        setContentView(R.layout.wu_transaction_history);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(TransactionHistory.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(TransactionHistory.class, false);
	    }
	    @Override
