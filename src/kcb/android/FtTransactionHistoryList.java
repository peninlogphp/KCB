...
import lipuka.android.view.adapter.FtTransactionHistoryAdapter;
import lipuka.android.view.adapter.ManageTransactionsAdapter;
import lipuka.android.view.adapter.MyAccountListAdapter;
import lipuka.android.view.adapter.TransactionHistoryAdapter;
...
public class FtTransactionHistoryList extends Activity implements OnClickListener, ResponseActivity,
AdapterView.OnItemClickListener{
	...
	String selectedSourceAccount, selectedProvider;
...
try{
	        setContentView(R.layout.ft_transaction_history_list);
 ...
 Bundle extras = getIntent().getExtras(); 
		...
		FtTransactionHistoryAdapter adapter = new FtTransactionHistoryAdapter(this, items);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(FtTransactionHistoryList.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(FtTransactionHistoryList.class, false);
	    }
	    @Override
	...
	/*    @Override
	        ...
	        return true;
	    		...
	    		public void onClick(View arg0) {
	    			 ...
	    			 if(arg0.getId() == R.id.more){
    			    	...
    			    	intent = new Intent(this, FtTransactionDetails.class);    	 	 
	   ...
	   public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
	   	...
	   	showDialog(Main.DIALOG_PIN_ID);
	   			break;
	   	case 1:
	   		Intent i = new Intent(FtTransactionHistoryList.this, AccountStmt.class);
		    startActivity(i);		
	   		break;
	   		
	   	case 2:
	   		i = new Intent(FtTransactionHistoryList.this, Alerts.class);
		    startActivity(i);	   		
	   			break;
	   		case 3:
	   			i = new Intent(FtTransactionHistoryList.this, ChangePINcfc.class);
			    startActivity(i);	
	   		    break;
	   		case 4:
	   			i = new Intent(FtTransactionHistoryList.this, SetLanguage.class);
			    startActivity(i);		
	   			break;
	   		case 5:
	   			i = new Intent(FtTransactionHistoryList.this, EditProfileCfc.class);
			    startActivity(i);	  			
	   			break;
	   		case 6:
