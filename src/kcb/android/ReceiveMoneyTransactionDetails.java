...
public class ReceiveMoneyTransactionDetails extends Activity implements OnClickListener, ResponseActivity,
DateCaptureActivity{
...
try{
	        setContentView(R.layout.wu_receive_money_transaction_details);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(ReceiveMoneyTransactionDetails.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(ReceiveMoneyTransactionDetails.class, false);
	    }
	    @Override
