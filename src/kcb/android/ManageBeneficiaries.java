...
public class ManageBeneficiaries extends Activity implements OnClickListener, ResponseActivity,
...
try{
	        setContentView(R.layout.wu_beneficiaries);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(ManageBeneficiaries.class, true);	    
	    }
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(ManageBeneficiaries.class, false);
	    }
	    @Override
...
amountStr = "You have successfully added "+aliasStr+" as beneficiary. Thank you.";
    		    	...
    		    	Intent intent = new Intent(this, EditBeneficiary.class);        
...
if(!fetchedBeneficiaries){
  ...
  try{      
   		...
   		ManageBeneficiariesAdapter adapter = new ManageBeneficiariesAdapter(this, items);
