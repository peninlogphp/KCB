...
public class Cheques extends Activity implements OnClickListener, ResponseActivity{
...
try{
	        setContentView(R.layout.cheques);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("Stop Cheque");
	        chequeNumber = (EditText) findViewById(R.id.cheque_number_field);
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating cheques error", ex);
	    ...
	    protected void onStart() {
	        super.onStart();
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(Cheques.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(Cheques.class, false);
	    }
	    @Override
	...
	/*    @Override
		...
		boolean valid = true;
	    			...
	    			String chequeNumberStr = chequeNumber.getText().toString();	

	    			if(chequeNumberStr == null || chequeNumberStr.length() == 0){
	    				valid = false;
	    				errorBuffer.append("Cheque number is missing\n");
	    			}
	    			    			
	    			    			if(valid){
	    			    				StringBuffer payloadBuffer = new StringBuffer();
	    			    			payloadBuffer.append(chequeNumberStr+"|");	    				
	    			    			...
	    			    			/*	lipukaApplication.setCurrentDialogTitle("Confirm");
	    			    			      lipukaApplication.setCurrentDialogMsg("You are about to pay KES "+chequeNumberStr+
	    			    			    		  " to your credit card account. Press \"OK\" to pay now or \"Cancel\" to edit payment details");
	    			    			showDialog(Main.DIALOG_CONFIRM_ID);	*/	
	    			    				showResponse();
	    			    			this.amountStr = chequeNumberStr;
	    			    			}else{
	   ...
	   public void showResponse(){
			lipukaApplication.setCurrentDialogTitle("Response");
		      /*lipukaApplication.setCurrentDialogMsg("Dear Alice, you have successfully paid KES "+amountStr+" to your credit card account. Thank you");
