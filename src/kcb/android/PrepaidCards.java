...
public class PrepaidCards extends Activity implements OnClickListener, ResponseActivity{
	...
	String selectedSourceAccount, selectedPrepaidCard;
	LipukaListItem[] sourceAccountsArray, prepaidCardsArray;
	    @Override
	    public void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);
	        lipukaApplication = (LipukaApplication)getApplication();
try{
	        setContentView(R.layout.prepaid_cards);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("Card Payments");
	  ...
	  try{      JSONArray sources = new JSONArray(lipukaApplication.loadSpinnerData(R.raw.transactional_accounts));
	    ...
	    final Spinner prepaidCardSpinner = (Spinner) findViewById(R.id.prepaid_card_spinner);
	    prepaidCardSpinner.setOnItemSelectedListener(new OnPrepaidCardSelectedListener());
        
  try{      JSONArray sources = new JSONArray(lipukaApplication.loadSpinnerData(R.raw.pay_bill_accounts));
         prepaidCardsArray = new LipukaListItem[sources.length()];
      JSONObject currentSource;
        for(int i = 0; i < sources.length(); i++){
        	currentSource = sources.getJSONObject(i);
        	LipukaListItem lipukaListItem = new LipukaListItem("", 
      currentSource.getString("name"), currentSource.getString("value"));
        	prepaidCardsArray[i]= lipukaListItem;   	
        }
        }catch(Exception ex){
	    	Log.d(Main.TAG, "creating prepaid cards list error", ex);

    	}
   	 ComboBoxAdapter prepaidCardsAdapter = new ComboBoxAdapter(this, android.R.layout.simple_spinner_item, prepaidCardsArray);
   	prepaidCardSpinner.setAdapter(prepaidCardsAdapter);
	   	...
	   	Button helpButton = (Button)findViewById(R.id.help);
	    	...
	    	Log.d(Main.TAG, "creating prepaid cards error", ex);
	    ...
	    protected void onStart() {
	        super.onStart();
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(PrepaidCards.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(PrepaidCards.class, false);
	    }
	    @Override
	...
	/*    @Override
		...
		boolean valid = true;
	    				...
	    				errorBuffer.append("Amount is missing\n");
	    			    			...
	    			    			payloadBuffer.append(amountStr+"|");	    				
	    			    				...
	    			    				/*lipukaApplication.setCurrentDialogTitle("Confirm");
	    			    			      lipukaApplication.setCurrentDialogMsg("You are about to load your "+selectedPrepaidCard+
	    			    			    		  " with KES "+amountStr+". Press \"OK\" to load now or \"Cancel\" to edit load prepaid card details");
	    	...
	    	pb.setVisibility(View.VISIBLE);
	    		...
	    		public class OnPrepaidCardSelectedListener implements OnItemSelectedListener {

		 	        public void onItemSelected(AdapterView<?> parent,
		 	            View view, int pos, long id) {
		 	        	selectedPrepaidCard = prepaidCardsArray[pos].getText();
		 	        	}
		 	        public void onNothingSelected(AdapterView parent) {
		 	          // Do nothing.
		 	        }
	   ...
	   public void showResponse(){
			lipukaApplication.setCurrentDialogTitle("Response");
		      /*lipukaApplication.setCurrentDialogMsg("Dear Alice, you have successfully loaded your "+selectedPrepaidCard+
	    			    			    		  " with KES "+amountStr+". Thank you");
