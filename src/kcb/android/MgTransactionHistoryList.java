...
import lipuka.android.view.adapter.MgTransactionHistoryAdapter;
...
public class MgTransactionHistoryList extends Activity implements OnClickListener, ResponseActivity,
...
try{
	        setContentView(R.layout.mg_transaction_history_list);
 ...
 Bundle extras = getIntent().getExtras(); 
		...
		MgTransactionHistoryAdapter adapter = new MgTransactionHistoryAdapter(this, items);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(MgTransactionHistoryList.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(MgTransactionHistoryList.class, false);
	    }
	    @Override
	...
	/*    @Override
	        ...
	        return true;
	    		...
	    		public void onClick(View arg0) {
	    		     ...
	    		     if(type == TransactionHistory.SEND_MONEY){
	    			    	intent = new Intent(this, MgTransactionDetails.class);    	 	 
	    		     }else{
	    			    	intent = new Intent(this, MgReceiveMoneyTransactionDetails.class);    	
	    		     }  
	   ...
	   public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
	   	...
	   	showDialog(Main.DIALOG_PIN_ID);
	   			break;
	   	case 1:
	   		Intent i = new Intent(MgTransactionHistoryList.this, AccountStmt.class);
		    startActivity(i);		
	   		break;
	   		
	   	case 2:
	   		i = new Intent(MgTransactionHistoryList.this, Alerts.class);
		    startActivity(i);	   		
	   			break;
	   		case 3:
	   			i = new Intent(MgTransactionHistoryList.this, ChangePINcfc.class);
			    startActivity(i);	
	   		    break;
	   		case 4:
	   			i = new Intent(MgTransactionHistoryList.this, SetLanguage.class);
			    startActivity(i);		
	   			break;
	   		case 5:
	   			i = new Intent(MgTransactionHistoryList.this, EditProfileCfc.class);
			    startActivity(i);	  			
	   			break;
	   		case 6:
