...
public class EditTransaction extends Activity implements OnClickListener, ResponseActivity,
DateCaptureActivity{
...
try{
	        setContentView(R.layout.wu_edit_transaction);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(EditTransaction.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(EditTransaction.class, false);
	    }
	    @Override
