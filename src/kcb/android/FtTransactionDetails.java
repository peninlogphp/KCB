...
public class FtTransactionDetails extends Activity implements OnClickListener, ResponseActivity,
DateCaptureActivity{
	   
	Button submit;
	TextView destination;
	TextView transactionType, testQuestion, testAnswer;
	RelativeLayout help;
...
try{
	        setContentView(R.layout.ft_transaction_details);
	        ...
	        TextView refNo = (TextView)findViewById(R.id.ref_no_field);
	        TextView amount = (TextView)findViewById(R.id.amount_field);
	        TextView balance = (TextView)findViewById(R.id.balance_field);
	        TextView fees = (TextView)findViewById(R.id.fees_field);
	        TextView currency = (TextView)findViewById(R.id.currency_field);
	        TextView source = (TextView)findViewById(R.id.source_field);
	        destination = (TextView)findViewById(R.id.destination_field);

	        transactionType = (TextView)findViewById(R.id.transaction_type_field);
	        try {
		        JSONObject transaction = new JSONObject(transactionStr);
	       
		        
		        dateNtime.setText(transaction.getString("date_n_time"));
	        refNo.setText(transaction.getString("ref_no"));
	        amount.setText(Formatters.formatAmount(transaction.getDouble("amount")));
	        fees.setText(Formatters.formatAmount(transaction.getDouble("fees")));
	        currency.setText(transaction.getString("currency"));
	        source.setText(transaction.getString("source_account"));
	        try{
	        	balance.setText(transaction.getString("balance"));
	        }
	        catch (org.json.JSONException jsonError) {
	    	     Log.d(Main.TAG, "jsonError: ", jsonError);
	          }
	        destination.setText(transaction.getString("destination_account"));
	        transactionType.setText(transaction.getString("transaction_type_desc"));
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(FtTransactionDetails.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(FtTransactionDetails.class, false);
	    }
	    @Override
