...
public class ReceiveMoney extends Activity implements OnClickListener, ResponseActivity{
	   
	Button submit;
	EditText mtcn, fname, lname, amount;
...
try{
	        setContentView(R.layout.wu_receive_money);
	        TextView title = (TextView) findViewById(R.id.title);
	        title.setText("Receive Money");
	        mtcn = (EditText) findViewById(R.id.mtcn_field);
...
mtcn.setInputType(InputType.TYPE_CLASS_NUMBER);		
	  ...
	  try{
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(ReceiveMoney.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(ReceiveMoney.class, false);
	    }
	    @Override
	...
	/*    @Override
		...
		boolean valid = true;
	    			...
	    			String mtcnStr = mtcn.getText().toString();	
	    		 ...
	    		 JSONObject currentSource = sources.getJSONObject(selectedDestinationIndex);
  			        	...
  			        	if(!currentSource.getString("account_type").equals("Remittance Account")){
	    			        ...
	    			        if(mtcnStr == null || mtcnStr.length() == 0){
	    				valid = false;
	    				errorBuffer.append("MTCN is missing\n");
	    			}
	    			...
	    			if(amountStr == null || amountStr.length() == 0){
	    				...
	    				errorBuffer.append("Amount is missing\n");
	    			    			...
	    			    			payloadBuffer.append(amountStr+"|");	    				
	    			    				...
	    			    				lipukaApplication.putPayload("mtcn", mtcnStr);
	    			    				...
	    			    				lipukaApplication.setCurrentDialogTitle("Confirm");
	    			    			      lipukaApplication.setCurrentDialogMsg("You are about to receive KES "+amountStr+
	    			    			    		  ", using MTCN "+mtcnStr+", sent by "+fnameStr+" "+lnameStr+" from "+selectedCountry+" into your "+selectedDestinationAccount+". Press \"OK\" to receive now or \"Cancel\" to edit receive money details.");
	    			    			showDialog(Main.DIALOG_CONFIRM_ID);			
	    			    			this.amountStr = "You have successfully received KES "+amountStr+
		    			    		  ", using MTCN "+mtcnStr+", sent by "+fnameStr+" "+lnameStr+" from "+selectedCountry+" into your "+selectedDestinationAccount+". Your new balance is KES 20,000. Thank you.";
	    			    			}else{
