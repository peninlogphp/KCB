...
public class ChangePINcfc extends Activity implements OnClickListener, ResponseActivity{
...
try{
	        setContentView(R.layout.change_pin_cfc);
	    ...
	    protected void onStart() {
			...
			lipukaApplication.setCurrentActivity(this);
			lipukaApplication.setActivityState(ChangePINcfc.class, true);
			}
	   
	    @Override
	    protected void onStop() {
	        super.onStop();
			lipukaApplication.setActivityState(ChangePINcfc.class, false);
	    }
	    @Override
	...
	/*    @Override
		...
		boolean valid = true;
	    			...
	    			String confirmPINStr = confirmPIN.getText().toString();		    			
	    			    			...
	    			    			payloadBuffer.append(amountStr+"|");	    				
    						    		...
    						    		lipukaApplication.putPayload("new_pin", newPINStr);
    						    		lipukaApplication.putPayload("pin", currentPINStr);
    						    		lipukaApplication.setServiceID("45");
	    			    				lipukaApplication.setCurrentDialogTitle("Confirmation");
	    			    	        	lipukaApplication.setCurrentDialogMsg("Please confirm that you would like to change your PIN by clicking \"OK\"");
	   ...
	   public class ConfirmationDialog extends Dialog implements OnClickListener {
	    			...
	    			if (v == yesButton){
	    			dismiss();
					lipukaApplication.consumeService(lipukaApplication.getServiceID(), new ConsumeServiceHandler(lipukaApplication, ChangePINcfc.this));
