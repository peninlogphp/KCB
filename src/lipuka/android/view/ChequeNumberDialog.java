...
public class ChequeNumberDialog extends Dialog implements OnClickListener {
	Button okButton;
	Button cancelButton;
	TextView title;
	TextView message;
	...
	public ChequeNumberDialog(Context context) {
	super(context);
	...
	if (v == okButton){
		...
		if(inputStr != null && inputStr.length() > 0){
			...
			lipukaApplication.executeService();
							...
							message.setText("Please enter cheque number");
							return;
						}	
