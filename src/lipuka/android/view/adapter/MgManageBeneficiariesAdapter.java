...
public  class MgManageBeneficiariesAdapter extends BaseAdapter {
    ...
    MgManageBeneficiaries manageBeneficiaries;
public MgManageBeneficiariesAdapter(MgManageBeneficiaries manageBeneficiaries, List<JSONObject> itemList) {
    this.manageBeneficiaries = manageBeneficiaries;
    mInflater = LayoutInflater.from(manageBeneficiaries);
this.itemList = itemList;
    prepareImageProcessor(manageBeneficiaries);
        }
...
public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
        convertView = mInflater.inflate(R.layout.mg_manage_beneficiaries_list_item, parent, false);
    ...
    holder.countryView.setText(item.getString("country_name"));
    
    holder.editView.setOnClickListener(manageBeneficiaries);
    holder.cancelView.setOnClickListener(manageBeneficiaries);
