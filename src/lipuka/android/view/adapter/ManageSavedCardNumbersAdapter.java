...
import kcb.android.ManageSavedCardNumbers;
...
public  class ManageSavedCardNumbersAdapter extends BaseAdapter {
    ...
    ManageSavedCardNumbers manageSavedCards;
public ManageSavedCardNumbersAdapter(ManageSavedCardNumbers manageSavedCards, List<JSONObject> itemList) {
...
public View getView(int position, View convertView, ViewGroup parent) {
    ...
    holder.countryView.setText(item.getString("card_no"));
