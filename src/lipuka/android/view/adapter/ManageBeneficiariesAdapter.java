...
public  class ManageBeneficiariesAdapter extends BaseAdapter {
...
public ManageBeneficiariesAdapter(ManageBeneficiaries manageBeneficiaries, List<JSONObject> itemList) {
...
public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
        convertView = mInflater.inflate(R.layout.wu_manage_beneficiaries_list_item, parent, false);
