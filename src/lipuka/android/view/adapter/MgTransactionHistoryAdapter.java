...
public  class MgTransactionHistoryAdapter extends BaseAdapter {
    ...
    MgTransactionHistoryList transactionHistoryList;
public MgTransactionHistoryAdapter(MgTransactionHistoryList transactionHistoryList, List<JSONObject> itemList) {
    this.transactionHistoryList = transactionHistoryList;
    mInflater = LayoutInflater.from(transactionHistoryList);
this.itemList = itemList;
    prepareImageProcessor(transactionHistoryList);
        }
...
public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (convertView == null) {
        convertView = mInflater.inflate(R.layout.mg_transaction_history_list_item, parent, false);
    ...
    holder.moreView.setOnClickListener(transactionHistoryList);
