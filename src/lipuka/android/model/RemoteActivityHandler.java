...
public class RemoteActivityHandler extends DefaultHandler {
 ...
 private LipukaList lipukaList;
	public RemoteActivityHandler(Main activity){
		super();
...
buffer.append(ch, start, length);
	     ...
	     public void handleSubmit(Attributes atts){
	    	// LipukaSubmitButton view = new LipukaSubmitButton(activity);
 ...
 view.setAction(atts.getValue("action"));
	     ...
	     public void handleNavigation(Attributes atts){
