...
public class FetchLariAtmLocationsHandler extends AsyncDatabaseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
   public FetchLariAtmLocationsHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
   ...
   public void onStart() {
	...
	lipukaApplication.consumeService(lipukaApplication.getServiceID(), new FetchLariAtmLocationsResponseHandler(lipukaApplication, activity));
        }
    	}
