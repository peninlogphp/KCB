...
public class FetchCardsHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String[] names;
    int[] ids;
   public FetchCardsHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
...
return;
        	 ...
        	 ((ManageSavedCards)activity).createList(response.getJSONArray("card_to_card_beneficiaries"));
