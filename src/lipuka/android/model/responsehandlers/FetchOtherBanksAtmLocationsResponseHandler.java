...
public class FetchOtherBanksAtmLocationsResponseHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
   public FetchOtherBanksAtmLocationsResponseHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
   ...
   public void onStart() {
	     Log.d(Main.TAG, "started fetching other banks atm locations remotely");	 	 
    ...
    public void onSuccess(String content) {
	     Log.d(Main.TAG, "got other banks atm locations: "+content);
	   ...
	   //  content = content.substring(content.indexOf("{")); 
        ...
        if (response.getInt("STATUS_CODE") == 1){
        	...
        	lipukaApplication.saveOtherBanksLocations(locationsArray);
	...
	((FindAtm)activity).setAutoCompleteData(new JSONArray());
