...
public class DeleteBeneficiaryHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String[] names;
    int[] ids;
   public DeleteBeneficiaryHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
...
return;
        	...
        	if(activity instanceof ManageBeneficiaries){
        		((ManageBeneficiaries)activity).deleteBeneficiary();       	
        	}else{
        		((MgManageBeneficiaries)activity).deleteBeneficiary();       	        		
        	}
