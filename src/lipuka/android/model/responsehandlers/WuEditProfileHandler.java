...
public class WuEditProfileHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String goldCardNo;
    int[] ids;
   public WuEditProfileHandler(LipukaApplication lipukaApplication,
		   Activity activity, String goldCardNo){
	   super();
	this.lipukaApplication = lipukaApplication;   
	this.activity = activity;   
	this.goldCardNo = goldCardNo;   
   }
    ...
    public void onSuccess(String content) {
     ...
     if (activity == lipukaApplication.getCurrentActivity()){
        ...
        if (response.getInt("STATUS_CODE") == 1){
			...
			lipukaApplication.putProfileData("gold_card_no", goldCardNo);
