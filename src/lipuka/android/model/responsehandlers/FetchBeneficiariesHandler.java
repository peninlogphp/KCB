...
public class FetchBeneficiariesHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String[] names;
    int[] ids;
   public FetchBeneficiariesHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
...
return;
            ...
            if(activity instanceof ManageBeneficiaries){
                ((ManageBeneficiaries)activity).createList(response.getJSONArray("beneficiaries"));
        	}else{
                ((MgManageBeneficiaries)activity).createList(response.getJSONArray("beneficiaries"));
        	}
