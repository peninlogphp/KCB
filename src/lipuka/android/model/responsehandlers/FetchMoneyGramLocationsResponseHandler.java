...
public class FetchMoneyGramLocationsResponseHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
   public FetchMoneyGramLocationsResponseHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
   ...
   public void onStart() {
	...
	((MgLocator)activity).setAutoCompleteData(new JSONArray());
