...
public class FetchCardAccountsHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String[] names;
    int[] ids;
   public FetchCardAccountsHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
...
return;
        	 ...
        	 ((ManageCardAccounts)activity).createList(response.getJSONArray("accounts"));
