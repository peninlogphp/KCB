...
public class DeleteCardNumberHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String[] names;
    int[] ids;
   public DeleteCardNumberHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
...
return;
        	 ...
        	 ((ManageSavedCardNumbers)activity).deleteCard();
