...
public class FetchFtTxnsHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String[] names;
    int[] ids;
   public FetchFtTxnsHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
...
return;
            ...
            Intent i = new Intent(activity, FtTransactionHistoryList.class);
            i.putExtra(Constants.TXNS, response.getString("statement"));
