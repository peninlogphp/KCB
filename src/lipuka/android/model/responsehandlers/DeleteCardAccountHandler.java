...
public class DeleteCardAccountHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String[] names;
    int[] ids;
   public DeleteCardAccountHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
...
return;
        	 ...
        	 ((ManageCardAccounts)activity).deleteCard();
