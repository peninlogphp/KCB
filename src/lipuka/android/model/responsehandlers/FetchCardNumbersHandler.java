...
public class FetchCardNumbersHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String[] names;
    int[] ids;
   public FetchCardNumbersHandler(LipukaApplication lipukaApplication,
		   Activity activity){
	   super();
...
return;
        	 ...
        	 ((ManageSavedCardNumbers)activity).createList(response.getJSONArray("card_to_card_beneficiaries_ben"));
