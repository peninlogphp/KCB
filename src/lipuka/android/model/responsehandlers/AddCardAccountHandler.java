...
import kcb.android.AddCardAccount;
...
public class AddCardAccountHandler extends AsyncHttpResponseHandler{

	LipukaApplication lipukaApplication;
	Activity activity;
	String cardNumber, cardHolderName, cvvCode, expiryDate;
    int[] ids;
   public AddCardAccountHandler(LipukaApplication lipukaApplication,
...
return;
            ...
            Intent i = new Intent(activity, AddCardAccount.class);
