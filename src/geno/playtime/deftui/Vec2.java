...
/**
 * Two dimensional vector class. TODO: Change to float or int even, to ease
 * calculations
 * 
 * @author Ying
 * 
...
public class Vec2 {
	 ...
	 * 
	 * @param v
	 *            is the Vec2 to compare against
	 ...
	 * 
	 * @param x
	 *            to add to the x component
	 * @param y
	 *            to add to the y component
	 */
	 ...
	 * 
	 * @param vec
	 *            Vec2 to check against
	 * @return True if they are equal, false if they are not.
	 */
	public boolean RoundEqual(Vec2 vec) {
		return ((Math.round(this.x) == Math.round(vec.X())) && (Math
				.round(this.y) == Math.round(vec.Y())));
	}
