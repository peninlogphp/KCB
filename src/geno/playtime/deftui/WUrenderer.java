...
public class WUrenderer implements Renderer {
	
	public static final  int SEND_MONEY = 0;
	public static final  int RECEIVE_MONEY = 1;
	public static final  int ACCOUNT_STATEMENT = 2;
	public static final byte MANAGE_TRANSACTIONS = 3;
	public static final byte TRANSACTION_HISTORY = 4;
...
Bitmap sendMoney, receiveMoney, manageTransactions,
...
public boolean scrolled = false;
	public WUrenderer(int screenWidth, int screenHeight, Context context) {
	...
	public void onDrawFrame(GL10 gl) {
		...
		gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
		gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[MANAGE_TRANSACTIONS]);
		gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
				GL10.GL_UNSIGNED_SHORT, indexBuffer);
...
sendMoney = BitmapFactory.decodeResource(context.getResources(), R.drawable.send_money);
receiveMoney = BitmapFactory.decodeResource(context.getResources(), R.drawable.receive_money);
manageTransactions = BitmapFactory.decodeResource(context.getResources(), R.drawable.manage_transactions);
transactionHistory = BitmapFactory.decodeResource(context.getResources(), R.drawable.transaction_history);
beneficiaries = BitmapFactory.decodeResource(context.getResources(), R.drawable.beneficiaries);
inquiriesNfaqs = BitmapFactory.decodeResource(context.getResources(), R.drawable.inquiries);
myAccount = BitmapFactory.decodeResource(context.getResources(), R.drawable.wu_my_account);
}
	...
	private void loadTextures(GL10 gl) {
		...
		loadTexture(gl, textures[ACCOUNT_STATEMENT], manageTransactions);
		loadTexture(gl, textures[MANAGE_TRANSACTIONS], transactionHistory);	
		loadTexture(gl, textures[TRANSACTION_HISTORY], beneficiaries);
