...
public class DeftUIRenderer implements Renderer {
	
	public static final  int FUNDS_TRANSFER = 0;
	public static final  int PAY_BILL = 1;
	public static final byte WESTERN_UNION = 2;
	public static final byte AIRTIME_TOPUP = 3;
	public static final  int ACCOUNT_STATEMENT = 4;
	public static final  int BALANCE = 5;
	public static final  int MY_ACCOUNT = 6;
	public static final  int FOREX = 7;
	public static final byte SETTINGS = 8;
	public static final byte LOCATOR = 9;
	public static final byte MONEYGRAM = 10;
	public static final byte CONTACT_US = 11;
	public static final byte PRODUCT_INFO = 12;
	public static final byte AGENCY_TRANSACTIONS = 13;
	public static final byte CHEQUES = 14;
	public static final byte INVESTMENTS = 15;
	public static final byte CARD_PAYMENTS = 16;
	public static final byte M_MONEY_TRANSFER = 17;
	public static final byte INSURANCE = 18;
	public static final byte TICKETS = 19;
	public static final byte CARD_TO_CARD_TRANSFERS = 20;
...
Bitmap fundsTransfer, payBill, westernUnion, airtimeTopup, accountStmt, balance,
myAccount, forex, settings, locator, moneygram, contactUs, productInfo, agencyTransactions,
cheques, investments, cardPayments, mobileMoneyTransfers, insurance, tickets, cardToCardTransfers;
...
public boolean scrolled = false;
	public DeftUIRenderer(int screenWidth, int screenHeight, Context context) {
	...
	public void onDrawFrame(GL10 gl) {
		...
		gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
		gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[AIRTIME_TOPUP]);
		gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
				GL10.GL_UNSIGNED_SHORT, indexBuffer);
		
		gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem5VertexBfr);
		gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
		gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[ACCOUNT_STATEMENT]);
		gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
				GL10.GL_UNSIGNED_SHORT, indexBuffer);
		...
		gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
		gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[CARD_TO_CARD_TRANSFERS]);
		gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
				GL10.GL_UNSIGNED_SHORT, indexBuffer);
		}else if(iconPlacement[0] == 2)
		{
			gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem1VertexBfr);
			gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
			gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[AGENCY_TRANSACTIONS]);
			gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
					GL10.GL_UNSIGNED_SHORT, indexBuffer);
			...
			gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem3VertexBfr);
			gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
			gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[INVESTMENTS]);
			gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
					GL10.GL_UNSIGNED_SHORT, indexBuffer);
			
			gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem4VertexBfr);
			gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
			gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[CARD_PAYMENTS]);
			gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
					GL10.GL_UNSIGNED_SHORT, indexBuffer);
			
			gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem5VertexBfr);
			gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
			gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[M_MONEY_TRANSFER]);
			gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
					GL10.GL_UNSIGNED_SHORT, indexBuffer);
			...
			gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem6VertexBfr);
			gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
			gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[INSURANCE]);
			gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
					GL10.GL_UNSIGNED_SHORT, indexBuffer);
			
			gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem7VertexBfr);
			gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
			gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[TICKETS]);
			gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
					GL10.GL_UNSIGNED_SHORT, indexBuffer);
			}else
			{
				...
				gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem2VertexBfr);
				gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
				gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[SETTINGS]);
				gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
						GL10.GL_UNSIGNED_SHORT, indexBuffer);
				...
				gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem4VertexBfr);
				gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
				gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[MONEYGRAM]);
				gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
						GL10.GL_UNSIGNED_SHORT, indexBuffer);
				...
				gl.glVertexPointer(3, GL10.GL_FLOAT, 0, leftMenuItem7VertexBfr);
				gl.glTexCoordPointer(2, GL10.GL_FLOAT, 0, textureBfr);
				gl.glBindTexture(GL10.GL_TEXTURE_2D, textures[CHEQUES]);
				gl.glDrawElements(GL10.GL_TRIANGLES, indices.length,
						GL10.GL_UNSIGNED_SHORT, indexBuffer);
				}
...
fundsTransfer = BitmapFactory.decodeResource(context.getResources(), R.drawable.funds_transfer);
payBill = BitmapFactory.decodeResource(context.getResources(), R.drawable.pay_bill);
westernUnion = BitmapFactory.decodeResource(context.getResources(), R.drawable.western_union);
airtimeTopup = BitmapFactory.decodeResource(context.getResources(), R.drawable.airtime);
accountStmt = BitmapFactory.decodeResource(context.getResources(), R.drawable.account_statement);
balance = BitmapFactory.decodeResource(context.getResources(), R.drawable.balance);
myAccount = BitmapFactory.decodeResource(context.getResources(), R.drawable.my_account);
forex = BitmapFactory.decodeResource(context.getResources(), R.drawable.forex);
settings = BitmapFactory.decodeResource(context.getResources(), R.drawable.settings);
locator = BitmapFactory.decodeResource(context.getResources(), R.drawable.locator);
moneygram = BitmapFactory.decodeResource(context.getResources(), R.drawable.moneygram);
contactUs = BitmapFactory.decodeResource(context.getResources(), R.drawable.contact_us);
productInfo = BitmapFactory.decodeResource(context.getResources(), R.drawable.product_info);
agencyTransactions = BitmapFactory.decodeResource(context.getResources(), R.drawable.agency_transactions);
cheques = BitmapFactory.decodeResource(context.getResources(), R.drawable.cheques);
investments = BitmapFactory.decodeResource(context.getResources(), R.drawable.investments);
cardPayments = BitmapFactory.decodeResource(context.getResources(), R.drawable.card_payments);
mobileMoneyTransfers = BitmapFactory.decodeResource(context.getResources(), R.drawable.mobile_money_transfer);
insurance = BitmapFactory.decodeResource(context.getResources(), R.drawable.insurance);
tickets = BitmapFactory.decodeResource(context.getResources(), R.drawable.tickets);
cardToCardTransfers = BitmapFactory.decodeResource(context.getResources(), R.drawable.card_to_card_transfer);
	...
	private void loadTextures(GL10 gl) {
		...
		loadTexture(gl, textures[FUNDS_TRANSFER], fundsTransfer);
		loadTexture(gl, textures[PAY_BILL], payBill);
		loadTexture(gl, textures[WESTERN_UNION], westernUnion);
		loadTexture(gl, textures[AIRTIME_TOPUP], airtimeTopup);
		loadTexture(gl, textures[ACCOUNT_STATEMENT], accountStmt);
		loadTexture(gl, textures[BALANCE], balance);
		loadTexture(gl, textures[MY_ACCOUNT], myAccount);
		loadTexture(gl, textures[FOREX], forex);	
		loadTexture(gl, textures[SETTINGS], settings);
		loadTexture(gl, textures[LOCATOR], locator);
		loadTexture(gl, textures[MONEYGRAM], moneygram);
		loadTexture(gl, textures[CONTACT_US], contactUs);
		loadTexture(gl, textures[PRODUCT_INFO], productInfo);
		loadTexture(gl, textures[AGENCY_TRANSACTIONS], agencyTransactions);
		loadTexture(gl, textures[CHEQUES], cheques);
		loadTexture(gl, textures[INVESTMENTS], investments);
		loadTexture(gl, textures[CARD_PAYMENTS], cardPayments);
		loadTexture(gl, textures[M_MONEY_TRANSFER], mobileMoneyTransfers);
		loadTexture(gl, textures[INSURANCE], insurance);
		loadTexture(gl, textures[TICKETS], tickets);
		loadTexture(gl, textures[CARD_TO_CARD_TRANSFERS], cardToCardTransfers);
